...
void init_style_style_panel_nav_bar_bottom_MAIN_CHECKED(lv_style_t *style) {
    lv_style_set_min_width(style, 800);
    lv_style_set_max_width(style, 800);
};

lv_style_t *get_style_style_panel_nav_bar_bottom_MAIN_CHECKED() {
    static lv_style_t *style;
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_style_panel_nav_bar_bottom_MAIN_CHECKED(style);
    }
    return style;
};
...
void add_style_style_panel_nav_bar_bottom(lv_obj_t *obj) {
    ...
    lv_obj_add_style(obj, get_style_style_panel_nav_bar_bottom_MAIN_CHECKED(), LV_PART_MAIN | LV_STATE_CHECKED);
};
...
void remove_style_style_panel_nav_bar_bottom(lv_obj_t *obj) {
    ...
    lv_obj_remove_style(obj, get_style_style_panel_nav_bar_bottom_MAIN_CHECKED(), LV_PART_MAIN | LV_STATE_CHECKED);
};
