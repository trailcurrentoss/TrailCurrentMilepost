...
#define USER_SSID "ESP32-S3-Touch-LCD-7B"  // Wi-Fi SSID (network name) for the Access Point
...
void app_main()
{
    ...
    Paint_DrawString_EN(30, 160, "ESP32-S3-Touch-LCD-7B", &Font24, RED, WHITE);  // Display title
    Paint_DrawString_EN(30, 200, "WiFi AP Test", &Font24, RED, WHITE);          // Display Wi-Fi test message
    Paint_DrawString_EN(30, 240, "1024x600", &Font24, RED, WHITE);                // Display screen resolution
